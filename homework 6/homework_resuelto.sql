...
-- luego ingopore esta funcion; ALTER TABLE alumno ADD COLUMN cedulaIdentidad VARCHAR(25);
-- termine modificando el codigo de l homework 05 agregando la columna cedula identidad
...
INSERT INTO alumno (idAlumno,cedulaIdentidad,nombre,apellido,fechaNacimiento,fechaIngreso,idCohorte)
VALUES 
  (41,'3122182K','Elvis','Macdonald','2008-12-19','2020-04-12',1236);
DELETE FROM alumno
WHERE idAlumno = 41
...
-- #6 DISTINCT Elimina los duplicados a mostrar para el select.
...
JOIN cohorte AS c ON (c.idInstructor = i.idInstructor)
